...
export default function PalletProfitCalculator() {
  ...
  return (
    <div className="p-4 max-w-xl mx-auto bg-white shadow-xl rounded-lg">
      <div className="text-center mb-6">
        <img src="/logo.png" alt="Blessings Bargain Barn" className="mx-auto h-24" />
        <h1 className="text-2xl font-bold mt-2 text-red-700">Blessings Bargain Barn</h1>
        <p className="text-gray-600">Reseller Profit Calculator</p>
      </div>
      ...
      <button onClick={calculate} className="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded font-bold shadow">
        Calculate
      </button>
      ...
      <footer className="text-center mt-10 text-sm text-gray-400 border-t pt-4">
        Part of the Blessings Family of Brands
      </footer>
    </div>
  );
}
